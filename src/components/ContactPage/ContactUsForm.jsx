...
const ContactUsForm = () => {
  ...
  return (
    <form
      className="flex flex-col rounded-2xl p-9 bg-blue-200 gap-7"
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="phonenumber" className="text-gray-900 font-bold ">
          Phone Number
        </label>
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="message" className="text-gray-900 font-bold ">
          Message
        </label>
        <textarea
          name="message"
