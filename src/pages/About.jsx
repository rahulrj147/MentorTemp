...
const About = () => {
  return (
    <div>
      ...
      <section className="border-b border-gray-600 text-g">
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-gray-500">
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[50%] flex-col gap-10">
              ...
              <p className="text-base font-medium text-gray-600 lg:w-[95%]">
      ...
      <StatsComponenet />
      <section className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-gray-700">
        <LearningGrid />
        <ContactFormSection />
      </section>
